...
async def generate_predictions(dataset_path, participant_model):
    """
    ...
    async for batch in tqdm(load_data_in_batches(dataset_path, batch_size), desc="Generating predictions"):
        batch_ground_truths = batch.pop("answer")  # Remove answers from batch and store them
        batch_predictions = await participant_model.batch_generate_answer(batch)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        queries, ground_truths, predictions = await generate_predictions(DATASET_PATH, participant_model)
